...
page_content = """<h1 class="text-3xl font-bold">Video Pipeline</h1>
<p class="text-sm">
    This demo showcases video-to-video pipeline using
    <a
...
href="https://huggingface.co/runwayml/stable-diffusion-v1-5"
    ...
    >. We also build in some LORAs for better stylization.
</p>
"""
...
class Pipeline:
    ...
    def __init__(self, args: Args, device: torch.device, torch_dtype: torch.dtype):
        ...
        self.stream = VideoPipelineWrapper(
